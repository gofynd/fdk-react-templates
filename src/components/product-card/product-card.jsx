...
const ProductCard = ({
  ...
  console.log(showSmartWishlist, "showSmartWishlist from product card");
  ...
  const wishlistStatus = useMemo(() => {
    console.log(
      productsInWishlist,
      "productsInWishlist from product card ",
      product?.slug
    );
    console.log("inside if", !productsInWishlist || !product?.slug);
    ...
    console.log(matchingSlug, "matchingSlug from product card");

    const count = matchingSlug ? productsInWishlist[matchingSlug].length : 0;

    console.log(count, "count from product card");
  ...
  console.log(wishlistStatus, "wishlistStatus from product card");
  ...
  console.log(
    `${(showSmartWishlist ? wishlistStatus.isInWishlist : isFollowed) ? styles.active : ""}`,
    "showSmartWishlist",
    showSmartWishlist,
    "wishlistStatus.isInWishlist",
    wishlistStatus.isInWishlist,
    "active class from product card"
  );
