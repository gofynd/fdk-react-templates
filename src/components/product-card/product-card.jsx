                ...
                <>
                  {product.contract && (
                    <Tooltip
                      ...
                      title={
                        <>
                          {t("resource.b2b.components.product_card.contract_applied")} -{" "}
                          {product?.contract?.used_count === 0 ? (
                            <>{product?.contract?.total_count} {t("resource.b2b.components.product_card.contract_applied")}</>
                          ) : (
                            <>
                              {product?.contract?.total_count -
                                product?.contract?.used_count}
                              /{product?.contract?.total_count} {t("resource.b2b.components.product_card.qty_available")}
                            </>
                          )}
                        </>
                      }
                    >
                      <div className={styles.badge_section}>
                        <div className={styles.badge}>
                          <span>{t("resource.b2b.components.product_card.contract_price")}</span>
                  ...
                  {product?.quotation && (
                    <Tooltip
                      ...
                      title={
                        <>
                          {t("resource.b2b.components.product_card.quote_applied")} -{" "}
                          {product?.quotation?.used_count === 0 ? (
                            <>{product?.quotation?.total_count} {t("resource.b2b.components.product_card.qty_available")}</>
                          ) : (
                            <>
                    ...
                    >
                      <div className={styles.badge_section}>
                        <div className={styles.badge}>
                          <span>{t("resource.b2b.components.product_card.quoted_price")}</span>
                          <span className={styles.info_icon}>
                            <SvgWrapper svgSrc="info-white" />
                          </span>
                        </div>
