...
function CreditPayment({
  ...
  const isPayDisabled =
    isCreditPaymentLoading || isInsufficientCredit || !isActive;
        ...
        <div className={styles.creditWrapper}>
          <div className={styles.creditCard}>
            <div className={styles.creditCardTopRow}>
              <p className={styles.creditLabel}>
                {t("resource.checkout.credit_available_credit")}
              </p>
              <div
                className={`${styles.creditReadyBadge} ${!isActive || isInsufficientCredit ? styles.creditReadyBadgeDanger : ""}`}
              >
                <span aria-hidden="true">&bull;</span>
                <span>
                  {!isActive
                    ? t("resource.checkout.credit_inactive")
            ...
            {!isActive ? (
              <p className={styles.insufficientCreditMsg}>
                {t("resource.checkout.credit_inactive_msg")}
              </p>
            ) : (
              isInsufficientCredit && (
                <p className={styles.insufficientCreditMsg}>
          ...
          {isTablet ? (
            ...
            <div className={styles.creditFooter}>
              <div className={styles.creditFooterLeft}>
                <span className={styles.youPayLabel}>
                  {t("resource.checkout.credit_you_pay")}
                </span>
