...
const AddToCart = ({
  ...
  const totalAvailableQuantity = productData?.totalAvailableQuantity;
  ...
  maxCartQuantity =
    maximumQuantity === null
      ...
      : Math.min(totalAvailableQuantity || Infinity, maximumQuantity);
                  ...
                  <>
                    {selectedItemDetails?.quantity && show_quantity_control ? (
                      ...
                      <FyButton
                        ...
                        disabled={
                          showQuantityController &&
                          (quantity === 0 || quantityError.hasError)
                        }
