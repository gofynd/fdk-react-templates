...
const AddToCart = ({
  ...
  // Debug: log quantity/display state when relevant values change
  useEffect(() => {
    console.log("[AddToCart][Debug] state snapshot", {
      quantity,
      displayCount,
      cartQuantity,
      selectedQuantityFromParent: productData?.selectedQuantity,
      selectedSize,
      sizeJustChanged,
      pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
      pincode: deliverInfoProps?.pincode ? "(set)" : "(empty)",
    });
  }, [quantity, displayCount, cartQuantity, productData?.selectedQuantity, selectedSize, sizeJustChanged, deliverInfoProps?.pincodeErrorMessage, deliverInfoProps?.pincode]);
                    ...
                    <B2BSizeQuantityControl
                      ...
                      onDecrementClick={(e) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onDecrementClick blocked (size-block)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        console.log("[AddToCart][PincodeCheck]", "onDecrementClick allowed (size-block)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          newQty,
                      ...
                      onIncrementClick={(e) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onIncrementClick blocked (size-block)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        const newQty =
                          displayCount +
                          (incrementDecrementUnit || minCartQuantity || 1);
                        console.log("[AddToCart][PincodeCheck]", "onIncrementClick allowed (size-block)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          newQty,
                      ...
                      onQtyChange={(e, currentNum) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onQtyChange blocked (size-block)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        console.log("[AddToCart][PincodeCheck]", "onQtyChange allowed (size-block)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          clampedQuantity,
                ...
                {showQuantityController && (
                  <div>
                    <B2BSizeQuantityControl
                      ...
                      onDecrementClick={(e) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onDecrementClick blocked (dropdown)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        const newQty =
                          displayCount -
                          (incrementDecrementUnit || minCartQuantity || 1);
                        console.log("[AddToCart][PincodeCheck]", "onDecrementClick allowed (dropdown)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          newQty,
                      ...
                      onIncrementClick={(e) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onIncrementClick blocked (dropdown)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        const newQty =
                          displayCount +
                          (incrementDecrementUnit || minCartQuantity || 1);
                        console.log("[AddToCart][PincodeCheck]", "onIncrementClick allowed (dropdown)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          newQty,
                      ...
                      onQtyChange={(e, currentNum) => {
                        if (deliverInfoProps?.pincodeErrorMessage) {
                          console.log("[AddToCart][PincodeCheck]", "onQtyChange blocked (dropdown)", {
                            pincodeErrorMessage: deliverInfoProps?.pincodeErrorMessage,
                            quantity,
                            displayCount,
                            cartQuantity,
                        ...
                        console.log("[AddToCart][PincodeCheck]", "onQtyChange allowed (dropdown)", {
                          quantity,
                          displayCount,
                          cartQuantity,
                          clampedQuantity,
