...
const AddToCart = ({
  ...
  console.log(isCartLoading, "sdfgmfskdwkmedd", typeof setIsCartLoading);
                  ...
                  <div>
                    <B2BSizeQuantityControl
                      ...
                      onQtyChange={(e, currentNum) => {
                        ...
                        console.log(currentNum, "currentNum");
                        if (cartQuantity === 0) {
                          if (currentNum > maxCartQuantity) {
                            currentNum = maxCartQuantity;
                          }
                          if (currentNum < minCartQuantity) {
                            currentNum = minCartQuantity;
                          }
                          if (currentNum % incrementDecrementUnit !== 0) {
                            currentNum =
                              Math.round(currentNum / incrementDecrementUnit) *
                              incrementDecrementUnit;
                          }
                          addProductForCheckout(
                            e,
                            selectedSize,
                            false,
                            showQuantityController ? currentNum : 0,
                            setIsCartLoading
                          );
                        }
                        cartUpdateHandler(e, currentNum, "edit_item");
