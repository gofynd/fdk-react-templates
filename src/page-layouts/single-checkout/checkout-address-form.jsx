...
import * as style from "./checkout-address-form.less";
...
const CheckoutAddressForm = ({
  ...
  const userdata = [
    {
      ...
      autofocus: true,
      showerror: false,
      value: isNewAddress ? "" : addressItem?.name,
      validateFn: () => {},
    ...
    },
    {
      ...
      showerror: false,
      validateFn: () => {},
      value: isNewAddress ? "" : addressItem?.phone,
    ...
    },
    {
      ...
      showerror: false,
      validateFn: () => {},
      value: isNewAddress ? "" : addressItem.email ? addressItem.email : "",
  ...
  const formdata = [
    {
      ...
      name: "address",
      type: "text",
      value: isNewAddress ? "" : addressItem?.address,
      showerror: false,
      validateFn: () => {},
    ...
    },
    {
      ...
      type: "text",
      showerror: false,
      value: isNewAddress ? "" : addressItem?.area,
      validateFn: () => {},
    ...
    },
    {
      ...
      type: "text",
      showerror: false,
      value: isNewAddress ? "" : addressItem?.landmark,
      validateFn: () => {},
  ...
  const pincode = {
    ...
    type: "text",
    showerror: false,
    value: isNewAddress ? "" : addressItem.area_code,
    validateFn: () => {},
  ...
  const City = {
    ...
    name: "city",
    type: "text",
    value: isNewAddress ? "" : addressItem.city,
  ...
  const State = {
    ...
    name: "state",
    type: "text",
    value: isNewAddress ? "" : addressItem.state,
  ...
  const Country = {
    ...
    name: "country",
    type: "text",
    value: isNewAddress ? "" : addressItem.country,
  ...
  const address_name = {
    ...
    type: "text",
    showerror: false,
    value: isNewAddress ? "" : addressItem.address_type,
  ...
  //   type: "text",
  //   showerror: false,
  //   value: isNewAddress ? "" : getAddressName(),
  //   validateFn: () => {},
  //   errortext: "Enter Address Name",
  // };
