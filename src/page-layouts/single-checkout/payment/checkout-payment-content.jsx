      ...
      if (tab === "CARD") {
        if (subMop === "newCard") {
          ...
          payload = {
            ...
            type: subMopData?.card_type,
            network: subMopData?.card_brand,
          };
        }
      } else {
        payload = {
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div className={styles.modePay}>
                              {!addNewCard && isMobile ? (
                                <StickyPayNow
                                  value={getCurrencySymbol + getTotalValue()}
      ...
      case "WL":
        ...
        const WalletItem = ({ wlt, key, openMoreWalletModal = false }) => {
          return (
            ...
            >
              <label onClick={(e) => selectMop("WL", "WL", wlt.code)}>
                <div className={styles.modeItem}>
            ...
            <div className={styles.modeOption}>
              ...
              {restWallets.length > 0 && (
                <div
                  ...
                  onClick={() => setOpenMoreWalletModal(true)}
                >
                  <div className={styles.modeItem}>
                    <div
                      style={{
                    ...
                    >
                      ...
                      <div className={styles.moreModeName}>More Wallets</div>
                    </div>
                    <SvgWrapper
                      className={
                      ...
                      {savedUpi?.map((item) => (
                        ...
                        >
                          <div
                            ...
                            key={item.vpa}
                            onClick={() => handleSavedUPISelect(item.vpa)}
                          >
                            <div
              ...
              <div className={styles.upiPay}>
                {isMobile ? (
                  <StickyPayNow
                    ...
                    value={getCurrencySymbol + getTotalValue()}
                    onPriceDetailsClick={onPriceDetailsClick}
                    proceedToPay={() => selectMop("UPI", "UPI", "UPI")}
                  />
                ) : (
      ...
      case "NB":
        ...
        const NbItem = ({ nb, key, openMoreNbModal = false }) => {
          return (
            ...
            >
              <label onClick={() => selectMop("NB", "NB", nb.code)}>
                <div className={styles.modeItem}>
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <div className={styles.modeItemLogo}>
            ...
            <div className={styles.modeOption}>
              ...
              {selectedTabData?.list?.length > initialVisibleBankCount && (
                <div
                  ...
                  onClick={() => setOpenMoreNbModal(true)}
                >
                  <div className={styles.modeItem}>
                    <div
                      style={{
              ...
              >
                ...
                {restBanks
                  .filter((nb) =>
                    nb.display_name
                      ?.toLowerCase()
                      .includes(nbSearchText?.toLowerCase())
                  )
                  .map((nb, index) => (
                    <NbItem
                      nb={nb}
                ...
                (payLater, index) =>
                  !payLater.isDisabled && (
                    ...
                    >
                      <label
                        id={payLater.id}
                        onClick={() => selectMop("PL", "PL", payLater.code)}
                      >
                        <div className={styles.modeItem}>
                          <div
                            style={{ display: "flex", alignItems: "center" }}
          ...
          <div>
            ...
            <div className={styles.modeOption}>
              {selectedTabData?.list?.map((op, index) => (
                ...
                >
                  <label onClick={() => setSelectedOtherPayment(op)}>
                    <div className={styles.modeItem}>
                      <div style={{ display: "flex", alignItems: "center" }}>
                        <div className={styles.modeItemLogo}>
                          <img
      ...
      >
        <div
          ...
          onClick={() => {
            ...
            setNavigationTitleName(opt.name);
            if (opt.name === navigationTitleName && isNavTabOpenMobile) {
              setIsNavTabOpenMobile(false);
            } else {
              setIsNavTabOpenMobile(true);
            }
          }}
        >
          <div
          ...
          <div className={`${styles.arrowContainer} ${styles["view-mobile"]}`}>
            <SvgWrapper
              className={
                selectedTab === opt.name && isNavTabOpenMobile
                  ? styles.upsideDown
                  : ""
              }
              svgSrc="accordion-arrow"
        ...
        >
          <div className={styles.codModal}>
            ...
            <button
              ...
              onClick={() => proceedToPay("COD", selectedPaymentPayload)}
            >
              CONTINUE WITH COD {getCurrencySymbol + getTotalValue()}
            </button>
          </div>
        </Modal>
      )}
                  ...
                  >
                    <div
                      ...
                      onClick={() => {
                        setTab("Other");
                        setSelectedTab("Other");
                        setNavigationTitleName("Other");
                        if (
                          navigationTitleName === "Other" &&
                          isNavTabOpenMobile
                        ) {
                          setIsNavTabOpenMobile(false);
                        } else {
                    ...
                    >
                      ...
                      >
                        <SvgWrapper
                          className={
                            selectedTab === "Other" && isNavTabOpenMobile
                              ? styles.upsideDown
                              : ""
                          }
                          svgSrc="accordion-arrow"
