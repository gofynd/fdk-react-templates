              ...
              <div className={styles.neftFormBlock}>
                <div className={styles.neftFormBlockInner}>
                  <section className={styles.neftSection}>
                    ...
                    <fieldset className={styles.neftFieldset}>
                      <legend className={styles.neftLegend}>
                        {utrLabel}
                        <span className={styles.requiredMark}>*</span>
                      </legend>
                      <div className={styles.neftUtrInputWrapper}>
                        <input
                          id="neftUtrNumber"
                          type="text"
                          value={utrNumber}
                        ...
                        {utrNumber?.trim?.() && (
                          <button
                            type="button"
                            className={styles.neftUtrCopyBtn}
                            onClick={() => handleCopyToClipboard(utrNumber)}
                            aria-label={t("resource.checkout.copy_utr_number")}
                          >
                            <CopyToClipboardSvg />
                          </button>
                        )}
