...
export const useAccounts = ({ fpi }) => {
  ...
  const updateProfile = (data) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(UPDATE_PROFILE, payload),
      null
    );
  };
  ...
  const signIn = (data) => {
    ...
    return fpi
      .executeGraphQL(
        updateGraphQueryWithValue(LOGIN_WITH_EMAIL_AND_PASSWORD, payload),
        null
      )
      .then((data) => {
        if (data?.errors) {
  ...
  const sendOtp = ({ mobile, countryCode }) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(LOGIN_WITH_OTP, payload),
      null
    );
  };
  ...
  const resendOtp = ({ mobile, countryCode, token, action }) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(SEND_OTP_ON_MOBILE, payload),
      null
    );
  };
  ...
  const signInWithOtp = ({ otp, requestId, isRedirection = true }) => {
    ...
    return fpi
      .executeGraphQL(
        updateGraphQueryWithValue(VERIFY_MOBILE_OTP, payload),
        null
      )
      .then((data) => {
        if (data?.errors) {
  ...
  const signUp = (data) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(REGISTER_WITH_FORM, payload),
      null
    );
  };
  ...
  const sendResetPasswordEmail = (data) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(SEND_RESET_PASSWORD_EMAIL, payload),
      null
    );
  };
  ...
  const resendVerifyEmailOtp = (data) => {
    ...
    return fpi.executeGraphQL(
      updateGraphQueryWithValue(SEND_OTP_ON_EMAIL, payload),
      null
    );
  };
  ...
  const verifyEmailOtp = (data) => {
    ...
    return fpi
      .executeGraphQL(
        updateGraphQueryWithValue(VERIFY_EMAIL_OTP, payload),
        null
      )
      .then((data) => {
        if (data?.errors) {
