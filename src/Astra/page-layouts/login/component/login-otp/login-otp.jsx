		...
		<div>
				...
				{!sendOtpSuccess ? (
					<form onSubmit={handleSubmit(handleSendOtp)}>
						<Controller
							...
							control={control}
							rules={{
								validate: (value) => value.isValidNumber || "Please enter valid phone number",
							}}
					...
					<div className={styles.loginInputGroup}>
						<p className={styles.otpSentMsg}>{`OTP sent to ${sendOtpResponse?.mobile}`}</p>
			...
			{sendOtpSuccess && (
				<div>
					...
					<button className={styles.verifyOtpBtn} disabled={!mobileOtp} onClick={verifyOtp}>
						Continue
					</button>
					<button
