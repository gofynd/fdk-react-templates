...
const Cart = ({ fpi,Loader,SvgWrapper,useLoggedInUser,FDKLink,useGlobalStore,useSnackbar, CART_DETAILS,CART_UPDATE,updateGraphQueryWithValue }) => {
  ...
  const {
    ...
    updateCartItems,
    gotoCheckout,
  } = useCart({fpi,useGlobalStore,useSnackbar, CART_DETAILS,CART_UPDATE,updateGraphQueryWithValue});
