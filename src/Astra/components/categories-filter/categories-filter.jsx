...
import * as styles from "../../styles/categories-filter.less";
    ...
    <div className={styles.singleFilterContainer}>
      ...
      >
        ...
        <SvgWrapper
                  ...
                  style={{ transform: open ? "scale(1,-1)" : "scale(1)" }} children={undefined}        />
      </div>
      {isCategoriesFilter &&
            ...
            >
              ...
              >
                <SvgWrapper
                          ...
                          style={{ fill: isSelected ? "var(--buttonPrimary)" : "none" }} children={undefined}                />
              </span>
