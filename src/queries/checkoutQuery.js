...
export const SELECT_ADDRESS = `mutation SelectAddress {
selectAddress(cartId: "$cartId", selectCartAddressRequestInput: {
  id: "$id",
  cart_id: "$cartId",
...
export const FETCH_SHIPMENTS = `query CartShipmentDetails {
cartShipmentDetails(addressId: "$addressId", id: "$cartShipmentDetailsId") {
  buy_now
  cart_id
  checkout_mode
  comment
...
export const PAYMENT_OPTIONS = `query PaymentModeRoutes {
...
export const SELECT_PAYMENT_MODE = `mutation SelectPaymentMode {
selectPaymentMode(updateCartPaymentRequestInput: {
...
checkoutCart(cartCheckoutDetailRequestInput: {
...
export const ORDER_BY_ID = `query Order {
