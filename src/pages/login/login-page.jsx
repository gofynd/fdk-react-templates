      ...
      <div className={styles.loginWrapper}>
        <div>
          ...
          {platformData?.display && (
            <h1 className={styles.loginTitle}>{platformData?.display}</h1>
          )}
          {platformData.subtext && (
            <p className={styles.loginSubText}>{platformData.subtext}</p>
          )}
          {isPassword && (
            <LoginPassword {...{ fpi, platformData, appFeatures }} />
          )}
          {isOtp && <LoginOtp {...{ fpi }} />}
          <div className={styles.loginBtnGroup}>
            {showLoginModeButton && (
              <LoginModeButton {...{ toggleLoginMode, isOtp }} />
            )}
