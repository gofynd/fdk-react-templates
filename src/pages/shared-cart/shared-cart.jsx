        ...
        <div className={styles.sharedCart}>
          ...
          <div className={styles.breakUpContainer}>
            ...
            <div className={styles.shareBtnContainer}>
              {showReplaceBtn ? (
                <button className={styles.shareBtn} onClick={onMergeBagClick}>
                  Merge Bag
                </button>
              ) : (
                <button className={styles.shareBtn} onClick={onAddToBagClick}>
                  Add To Bag
                </button>
              )}
              {showReplaceBtn && (
                <button className={styles.shareBtn} onClick={onReplaceBagClick}>
                  Replace Bag
                </button>
              )}
            </div>
